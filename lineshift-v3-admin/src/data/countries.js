export const countries = [
  ...
  { code: "BQ", alpha3: "BES", name: "Caribbean Netherlands" },
  ...
  { code: "CD", alpha3: "COD", name: "Congo (Democratic Republic)" },
  { code: "CF", alpha3: "CAF", name: "Central African Republic" },
  { code: "CG", alpha3: "COG", name: "Congo (Republic)" },
  ...
  { code: "CZ", alpha3: "CZE", name: "Czech Republic" },
  ...
  { code: "US", alpha3: "USA", name: "United States of America" },
  ...
  { code: "VG", alpha3: "VGB", name: "British Virgin Islands" },
  { code: "VI", alpha3: "VIR", name: "U.S. Virgin Islands" },
...
export const getCountryByCode = (code) => {
  ...
  return countries.find((c) => c.code === upperCode || c.alpha3 === upperCode);
};
...
// Popular countries for prioritized display
